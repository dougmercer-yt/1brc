"""Submitted by YouTube commenter @sohamtilkar5126.

They suggested disabling garbage collection.

Performance
-----------
Doesn't meaningfully change performance.

Discussion
----------
I wasn't sure if this would help. It seems to not make a significant difference
on my machine.
"""
